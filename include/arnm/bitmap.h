...
// add in program used builtin functions plattform independently usable https://gcc.gnu.org/onlinedocs/gcc/Bit-Operation-Builtins.html
// Returns the number of trailing 0-bits in bitmap, starting at the least significant bit position. If x is 0, the result is undefined.
